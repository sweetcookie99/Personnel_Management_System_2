...
<ul>
    ...
    <li><a class="active" href="#">部门信息</a></li>
...
<table width="50%" id="mytab"  border="1" class="t1">
  ...
  <th width="10">序号</th>
    ...
    <tr class="a1">
        ...
        <th><a onclick="fn()" href="UserServlet?type=delete&id=<%=dept.getId()%>">删除</a></th>
        <th><a href="UserServlet?type=gotoUpdate&id=<%=dept.getId()%>">修改</a></th>
    </tr>
    <%
        }
        if (i%2!=0){%>
